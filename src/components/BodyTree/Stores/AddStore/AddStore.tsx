...
import Styles from '@/components/BodyTree/Stores/AddStore/AddStore.module.scss'
        ...
        <div className={Styles.formInput}>
          <div className={Styles.flex1}>
            ...
            <SelectAbove
              ...
              title={
                <>
                  Parent Store <Switch check={isParent} setCheck={setIsParent} />
                </>
              }
              data={[]}
              isRequired={false}
